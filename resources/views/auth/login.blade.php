                ...
                <div class="grid grid-cols-1 md:grid-cols-2">
                    ...
                    <div class="hidden md:flex flex-col justify-center p-10 bg-gradient-to-br from-white/40 to-white/10 dark:from-slate-900/40 dark:to-slate-900/10">
                        ...
                        <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                            Log in to continue your game and join live rooms.
                        </p>
                        <ul class="mt-6 space-y-2 text-sm text-gray-700/90 dark:text-gray-300/90">
                            ...
                            <li class="flex items-center gap-2">
                                ...
                                Persistent profiles and colors
                            </li>
                            <li class="flex items-center gap-2">
                                <span class="inline-block size-1.5 rounded-full bg-fuchsia-500"></span>
                                Smooth, animated UI
                            </li>
                        </ul>
                    </div>

                    {{-- Right side: actual form (kept narrow within the wider card) --}}
                    <div class="p-6 sm:p-8 md:p-10 max-w-md w-full mx-auto">
                        <h1 class="text-2xl font-semibold tracking-tight text-gray-900 dark:text-gray-100">Log in</h1>
                        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Enter your credentials to continue.</p>
                        ...
                        {{-- Keep form width comfortable on large screens --}}
                        <form method="POST" action="{{ route('login') }}" class="mt-6 max-w-md">
                            @csrf
